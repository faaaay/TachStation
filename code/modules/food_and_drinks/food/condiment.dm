...
/obj/item/reagent_containers/food/condiment/pack
	...
	possible_states = list("ketchup" = list("condi_ketchup", "Ketchup", "You feel more American already."),
	...
	"sugar" = list("condi_sugar", "Sugar", "Tasty spacey sugar!"), "astrotame" = list("condi_astrotame",
	"Astrotame", "The sweetness of a thousand sugars but none of the calories."))
...
/obj/item/reagent_containers/food/condiment/pack/soysauce
	name = "soysauce pack"
	originalname = "soysauce"
	list_reagents = list("soysauce" = 10)
