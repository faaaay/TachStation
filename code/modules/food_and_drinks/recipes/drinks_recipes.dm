...
/datum/chemical_reaction/shirleytemple
	name = "Shirley Temple"
	id = "shirleytemple"
	results = list("shirleytemple" = 5)
	required_reagents = list("space_up" = 2, "orangejuice" = 2, "grenadine" = 1)
...
/datum/chemical_reaction/milkshake
	name = "Milkshake"
	id = "milkshake"
	results = list("milkshake" = 15)
	required_reagents = list("milk" = 5, "ice" = 5, "cream" = 5)
